...
class AutoSignInMod(_PluginBase):
    ...
    # 插件配置项ID前缀
    plugin_config_prefix = "autosigninmod_"
    # 加载顺序
    plugin_order = 0
    # 可使用的用户级别
    auth_level = 2
    ...
    def _get_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "auto_cf": self._auto_cf,
            "clean": self._clean,
            "all_sites": site_options
        }

    def _get_history(self) -> Dict[str, Any]:
        """API Endpoint: Returns signin and login history."""
        # 获取最近14天的日期数组
        date_list = [(datetime.now() - timedelta(days=i)).date() for i in range(14)]
