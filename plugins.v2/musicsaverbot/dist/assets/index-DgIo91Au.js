...
import _sfc_main$1 from './__federation_expose_Config-Bt8zT9w9.js';
    ...
    _createVNode$2h(_component_v_app, null, {
      default: _withCtx(() => [
        ...
        _createVNode$2h(_component_v_footer, {
          ...
          default: _withCtx(() => [
            _createElementVNode("span", _hoisted_3, "音乐保存机器人插件 ©" + _toDisplayString(new Date().getFullYear()), 1)
          ]),
          _: 1
        })
      ]),
...
const App = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-8a8fb8be"]]);
