...
import _sfc_main$1 from './__federation_expose_Config-qRp3okKa.js';
import PageComponent, { _ as _export_sfc } from './__federation_expose_Page-CHB41Ahn.js';
import { aF as propsFactory, ai as includes, ao as isOn, Z as eventName, a3 as genericComponent, a5 as getCurrentInstance, aI as provideTheme, F as createLayout, aV as useRtl, aw as makeThemeProps, av as makeLayoutProps, aG as provideDefaults, w as convertToUnit, X as destructComputed, al as isCssColor, ap as isParsableColor, aC as parseColor, a9 as getForeground, a6 as getCurrentInstanceName, l as SUPPORTS_INTERSECTION, t as clamp, v as consoleWarn, aT as useProxiedModel, aX as useToggleScope, aR as useLayoutItem, au as makeLayoutItemProps, ad as getUid, $ as findChildrenWithProvide, O as deepEqual, aY as wrapInArray, aP as useIcon, j as IconValue, a0 as flattenFragments, aU as useResizeObserver, I as IN_BROWSER, ag as hasEvent, an as isObject, aq as keyCodes, aS as useLocale, E as EventProp, _ as filterInputAttrs, ax as matchesSelector, aA as omit, aB as only, aN as useDisplay, aO as useGoTo, a2 as focusableChildren, at as makeDisplayProps, u as consoleError, Q as defineComponent, W as deprecate, ac as getPropertyFromItem, a1 as focusChild, P as defer, aK as templateRef, aj as isClickInsideElement, aa as getNextElement, aD as pick, r as callEvent, N as debounce, Y as ensureValidVNode, s as checkPrintable, az as noop, aW as useTheme, aE as pickWithRest, as as keys, a8 as getEventCoordinates, h as HexToHSV, f as HSVtoHex, H as HSLtoHSV, e as HSVtoHSL, k as RGBtoHSV, g as HSVtoRGB, af as has, a7 as getDecimals, K as createRange, ar as keyValues, S as SUPPORTS_EYE_DROPPER, d as HSVtoCSS, R as RGBtoCSS, a4 as getContrast, ak as isComposingIgnoreKey, ab as getObjectValueByPath, am as isEmpty, U as defineFunctionalComponent, q as breakpoints, aL as useDate, ae as getWeek, ah as humanReadableFileSize, aH as provideLocale, aQ as useLayout, C as CircularBuffer, p as VuetifyLayoutKey, aJ as refElement, V as VClassIcon, m as VComponentIcon, n as VLigatureIcon, o as VSvgIcon } from './date-ZnH8yrYf.js';
...
const {createTextVNode:_createTextVNode$7,resolveComponent:_resolveComponent,withCtx:_withCtx,createVNode:_createVNode$2h,unref:_unref,createElementVNode:_createElementVNode,toDisplayString:_toDisplayString,openBlock:_openBlock,createElementBlock:_createElementBlock} = await importShared('vue');
    ...
    _createVNode$2h(_component_v_app, null, {
      default: _withCtx(() => [
          ...
          default: _withCtx(() => [
            _createVNode$2h(_component_v_app_bar_title, null, {
              default: _withCtx(() => [...(_cache[4] || (_cache[4] = [
                _createTextVNode$7("站点自动签到魔改版", -1)
              ]))]),
              _: 1
            })
          ]),
        ...
        _createVNode$2h(_component_v_footer, {
          ...
          default: _withCtx(() => [
            _createElementVNode("span", _hoisted_4, "站点自动签到插件 ©" + _toDisplayString(new Date().getFullYear()), 1)
          ]),
          _: 1
        })
      ]),
...
const App = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-713f4aee"]]);
